#-------------------------------------------------
#
# Project created by QtCreator 2023-07-24T22:08:16
#
#-------------------------------------------------
...
# INCLUDEPATH += /opt/sqlite3/include
 INCLUDEPATH += /opt/arm/opencv/arm-opencv/include
 INCLUDEPATH += /opt/arm/opencv/arm-opencv/include/opencv
 INCLUDEPATH += /opt/arm/opencv/arm-opencv/opencv2

 LIBS += -L/opt/arm/opencv/arm-opencv/lib -lopencv_calib3d -lopencv_flann -lopencv_objdetect \
 -lopencv_videoio -lopencv_core -lopencv_highgui -lopencv_photo \
 -lopencv_video -lopencv_imgcodecs -lopencv_shape \
 -lopencv_videostab  -lopencv_imgproc -lopencv_stitching \
 -lopencv_features2d -lopencv_ml -lopencv_superres

# LIBS += -L/opt/sqlite3/lib
