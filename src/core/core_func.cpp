    ...
    for (int color_index = 0; color_index < 2; color_index++) {
      ...
      for (auto plate : plateVec) {
        ...
        if (0 && showDebug) {
          ...
          ss << "resources/image/tmp/" << img_index << "_1_" << "searcgMserRect.png";
      ...
      if (1) {
        std::stringstream ss(std::stringstream::in | std::stringstream::out);
        ss << "resources/image/tmp/plateDetect/plate_" << img_index << "_" << the_color << ".png";
        imwrite(ss.str(), result);
      }
    }
...
//  if not exit, return false
  ...
  Mat showResult(const Mat &result, int img_index) {
    ...
    if (1) {
      std::stringstream ss(std::stringstream::in | std::stringstream::out);
      ss << "resources/image/tmp/Result/plate_" << img_index << ".png";
  ...
  void writeTempImage(const Mat &outImg, const string path, int index) {
    ...
    ss << "resources/image/tmp/" << path << "_" << std::string(buf) << "_" << index << ".png";
